	...
	private boolean isValidMove(String zugeingabe) { //Speicherung nummer, buchstabe (undd richtung)
		if (zugeingabe.length() > 3||zugeingabe.length() < 2) {
			if (zugeingabe.length() ==4) { //Ausnahme 10
				if ((zugeingabe.charAt(0)=='1')&&(zugeingabe.charAt(1)=='0')&&((zugeingabe.charAt(2)=='a')||(zugeingabe.charAt(2)==(char)('a'+this.hoehe-3)))) {
					this.nummer=10;
					this.buchstabe=zugeingabe.charAt(2);
				}
				else 	if ((zugeingabe.charAt(1)=='1')&&(zugeingabe.charAt(2)=='0')&&((zugeingabe.charAt(0)=='a')||(zugeingabe.charAt(0)==(char)('a'+this.hoehe-3)))) {
					this.nummer=10;
